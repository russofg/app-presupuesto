...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast.error("No se pudo crear la cuenta. Verificá los datos e intentá de nuevo.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (!msg.includes("popup-closed-by-user") && !msg.includes("cancelled-popup-request")) {
        toast.error("No se pudo continuar con Google. Intentá de nuevo.");
      }
    } finally {
    ...
    <>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Empezá tu camino hacia la claridad financiera
        </p>
      </div>
